...
| Quantum-aware digest policy | Configurable digest strength profiles for SHA3-256, SHA3-384, SHA3-512, SHAKE256-256, and SHAKE256-512 with full-width world, content, and manifest digest types before durable storage authority | Planned | `docs/IMPLEMENTATION_PLAN.md` |
